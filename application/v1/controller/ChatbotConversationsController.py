...
from application.v1.repository.ChatbotConversationsRepository import ChatbotConversationsRepository
from application.v1.repository.UsersRepository import UsersRepository
from application.v1.repository.AttendanceRepository import AttendanceRepository
from application.v1.repository.ActivitiesRepository import ActivitiesRepository
from application.v1.repository.BehaviorRecordsRepository import BehaviorRecordsRepository
from application.v1.repository.AcademicRecordsRepository import AcademicRecordsRepository
from application.config.postgres_orm_config import scoped_session_factory
from application.config.logger_config import LogConfig
from application.constants.intent_classification import INTENT_CLASSIFICATION_PROMPT
from application.constants.llm_prompts import FINAL_ANSWER_PROMPT
import requests
import uuid
import os
